...
const Main = ({places, placesCount, onNameClick}) => {
  return (
            ...
            <section className="cities__places places">
              ...
              <form className="places__sorting" action="#" method="get">
                ...
                <select className="places__sorting-type" id="places-sorting">
                  <option className="places__option" defaultValue="popular" value="selected">Popular</option>
              ...
              <div className="cities__places-list places__list tabs__content">
                ...
                {places.map((place, index) => {
                  return (
                    <article className="cities__place-card place-card" key={`place-card-` + index}>
                      ...
                      <div className="place-card__info">
                        ...
                        <h2 className="place-card__name">
                          <a href="#" onClick={onNameClick}>{place}</a>
                        </h2>
